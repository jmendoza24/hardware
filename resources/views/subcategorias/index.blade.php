...
@section('content')
    <div class="col-md-12">    
    <h1 class="pull-right">
       <span class="btn btn_azul pull-right" style="margin-top: -10px;margin-bottom: 5px" onclick="ver_catalogo(4,0,1,{{ $catalogo->id_fabricante}},{{ $catalogo->catalogo}},{{$catalogo->familia}},{{$catalogo->id}})" data-toggle="modal" data-backdrop="false" data-target="#primary">+ Subcategoria</span>
    </h1>
    </div>
    <br><br><br>
