	...
	<table class="table table-striped padding-table table-bordered">
		...
		<tr>
			...
			<td style="text-align: right;">
				<label id="lp_<?php echo e($d->id_catalogo); ?>"><?php echo e(number_format($d->lp * $d->ctd,2)); ?></label>
			</td>
...
</div><?php /**PATH /home/altermed/public_html/hardwarecollection.mx/laravel/resources/views/cotizador/tabla_dependencia.blade.php ENDPATH**/ ?>