...
<div class="row">
    <div class="col-md-12">
        <span class="btn btn-outline-primary pull-right" onclick="ver_catalogo(15,0,1,<?php echo e($clientes->id_cliente); ?>)" data-toggle="modal" data-backdrop="false" data-target="#primary">+ Contacto</span>
    </div>
    <br><br><br>
...
<div class="form-group col-sm-12" style="text-align: right;">
    ...
    <a href="<?php echo route('clientes.index'); ?>" class="btn btn-warning">Cancelar</a>
</div><?php /**PATH C:\wamp64\www\laravel\hardware\resources\views/clientes/fields.blade.php ENDPATH**/ ?>