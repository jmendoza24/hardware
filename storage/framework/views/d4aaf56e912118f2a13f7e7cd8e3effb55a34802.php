...
<style type="text/css">
	...
	<table class="table table-striped small row-border" style="font-size: 13px;" id="" border="0">
		<tr style="border-top: 2px solid white; background:white;">
			<td colspan="6"><span class="badge badge-primary">Cotización <?php echo e($num_cotizacion); ?></span></td>
		...
		<tr>
			...
			<td>
				<?php echo e(str_replace('xxx', $p->finish, $p->codigo_sistema)); ?>

				<span class="pull-right btn-group">
					<span class="btn btn-sm btn-outline-primary" data-toggle="modal" data-backdrop="false" data-target="#primary" style="cursor: pointer; font-size: 12px;" onclick="agregar_dependencia(<?php echo e($p->idproducto); ?>,<?php echo e($p->id); ?>)"><i class="fa fa-info"></i></span>
					<span class="btn btn-sm btn-outline-success" onclick="agrega_producto(<?php echo e($p->idproducto); ?>)"><i class="fa fa-plus"></i></span>
				</span>
			</td>
			<td><?php echo e(number_format($p->lp + $p->sum_lp,2)); ?></td>
			<td><?php echo e(number_format($p->phc + $p->sum_phc,2)); ?></td>
			<td><?php echo e(number_format($p->pvc + $p->sum_pvc,2)); ?></td>
			<td>
			...
			<td class="text-right"> <label > $<?php echo e(number_format(($p->pvc * $p->cantidad) + $p->sum_pvc,2)); ?></label></td>
		...
		<tr>
			...
			<td></td>
			<td colspan="3" class="text-right"  style="border-left: 3px solid white;">$<?php echo e(number_format($subtotal_ps,2)); ?></td>
		</tr>
		<tr>
			...
			<td colspan="2"  style="border-left: 3px solid white;"><input type="text" id="descuento_mx" class="form-control form-control-sm desc-mask pull-right" value="<?php echo e($cotizacion->descuento_mx); ?>" style="width: 55px;" onchange="guardar_descuentos()"></td>
			<td class="text-right" >
		...
		<tr>
			...
			<td  style="background:#67A957;border-left: 3px solid white;" class="text-right  white" colspan="3"> + MXN: $<?php echo e(number_format($desc_mx + (($desc_mx * $cotizacion->iva_mx)/100),2)); ?></td>
		</tr>
