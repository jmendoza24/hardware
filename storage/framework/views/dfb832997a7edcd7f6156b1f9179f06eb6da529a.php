        ...
        <tbody>
            <?php $__currentLoopData = $cotizaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                            <a class="btn btn-sm btn-outline-primary btn_gris" href="#" onclick="cambia_oc(<?php echo e($c->id); ?>)"><i class="fa fa-retweet"></i></a> &nbsp;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/altermed/public_html/demo.cotiza.tech/laravel/resources/views/cotizador/lista.blade.php ENDPATH**/ ?>