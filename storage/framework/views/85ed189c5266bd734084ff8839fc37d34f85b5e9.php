<form id="catalogos_forma" action="">
    ...
    <hr>
    <div class="form-group col-sm-12">
        <span class="btn btn_azul pull-right" onclick="guarda_catalogo(15,<?php echo e($participantes->id); ?>,1,'tabla_catalogos')">Guardar</span>
    </div>
</form><?php /**PATH /home/altermed/public_html/hardwarecollection.mx/laravel/resources/views/clientes/participantes_fields.blade.php ENDPATH**/ ?>