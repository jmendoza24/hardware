...
<div class="col-md-12 text-right">
    <?php for($i = 1; $i<= $conteo; $i++): ?>
        <span class="btn btn-<?php echo e($i!= $init ? 'outline-' : ''); ?>primary btn-sm" onclick="buscar_producto(<?php echo e($i); ?>)"><?php echo e($i); ?></span>
    <?php endfor; ?>
</div>
...
<?php /**PATH C:\wamp64\www\laravel\hardware\resources\views/productos/table.blade.php ENDPATH**/ ?>