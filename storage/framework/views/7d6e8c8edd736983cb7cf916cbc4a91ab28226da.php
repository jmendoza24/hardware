<table class="table small table-striped table-bordered">
	<tr>
		<td colspan="4" style="text-align: left;"><span class="badge badge-info">Info: <b><?php echo e($producto->info); ?></b></span></td>
		...
		<td style="text-align:right; width: 9%;">$<?php echo e(number_format($detalle->lp + $detalle->extra,2)); ?></td>
	...
	<tr>
		...
		<td class="gris_tabla"> <?php echo e($producto->info != 6 ?'Sufijo:':''); ?></td>
		<td>
			<?php echo e($producto->info != 6 ? $info_adic->sufijo : ''); ?> 
		</td>
	...
	<tr>
		...
		<td class="gris_tabla"> <?php echo e($producto->info != 6 ? 'Handing:':''); ?> </td>
		<td>
			<?php if($producto->info == 5 || $producto->info == 7 && $producto->info != 6): ?>
	...
	<tr>
		<td class="gris_tabla">Descripción:</td>
		<td></td>
		<td class="gris_tabla"><?php echo e($producto->info != 6 ? 'Style:':''); ?></td> 
		<td>
			<?php if($producto->info != 5 && $producto->info != 7 && $producto->info != 6): ?>
			<?php 
