...
<table   style="width: 100%; font-family: sans-serif; color:white; border-collapse: collapse;">
     ...
     <tr style="background: #D2D2D2; color:#5C8293; font-size: 11px; padding-top: 3px;">
        ...
        <td style="text-align: right;">cotizacionización válida  hasta <br/> <?php echo e(date("d",strtotime($cotizacion->created_at)). ' de ' .$a[date("m",strtotime($cotizacion->created_at))+1] . ' de '.date("Y",strtotime($cotizacion->created_at))); ?>
