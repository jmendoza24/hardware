...
<div class="row" id="elementos_mtk" style="<?php echo e($productos->fabricante!=76 ? 'display:none':''); ?>">
    ...
    <div class="form-group col-sm-6">
        <?php echo Form::label('finish', 'LATCH:'); ?>

        <select class="form-control" name="latch_ext">
            <option value="">Seleccione...</option>
            <option value="1" <?php echo e($productos->latch_ext==1 ? 'selected':''); ?>>Si</option>
            <option value="0" <?php echo e($productos->latch_ext==0 ? 'selected':''); ?>>No</option>
        </select>
    </div>
</div>
...
<div class="row">
    ...
    <div class="form-group col-sm-6">
        ...
        <select class="form-control" name="handing" id="handing">
            <option value="">Seleccione una opcion</option>
            <?php $__currentLoopData = $sub_baldwins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($s->variable==2 and $s->fabricante==0): ?>
                <option value="<?php echo e($s->id); ?>" <?php echo e($productos->handing==$s->id?'selected':''); ?>><?php echo e($s->subcatalogo); ?></option>
                <?php endif; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
    </div>
