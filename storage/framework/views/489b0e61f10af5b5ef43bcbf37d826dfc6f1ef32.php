...
<table class="table table-striped  table-bordered " id="tabla-asi">
    ...
    <tbody>
        ...
        <tr>
            <td><span class="blue" onclick="ver_catalogo(15,<?php echo e($p->id); ?>,2,<?php echo e($clientes->id_cliente); ?>)" data-toggle="modal" data-backdrop="false" data-target="#primary" style="cursor: pointer;"><b><?php echo e($p->contacto); ?></b></span></td>
            <td><?php echo e($p->correo); ?></td>
            <td><?php echo e($p->telefono); ?></td>
            <td><?php echo e($p->puesto); ?></td>
            <td><?php echo e($p->activo==1?'Activo':'Inactivo'); ?></td>
            <td><button class="btn btn-danger btn-sm" type="button" onclick="elimina_catalogo(15,<?php echo e($p->id); ?>,'tabla_catalogos',<?php echo e($p->id_cliente); ?>)"><i class="fa fa-trash"></i></button></td>
        </tr>
