<div style="color: white; background-color: #5C8293  !important;"class=" main-menu menu-fixed menu-dark menu-accordion menu-shadow" >
    <div class="main-menu-content " style="color: white; background-color: #5C8293  !important;">
      <ul style="color: white; background-color: #5C8293  !important;" class=" navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class=" nav-item <?php echo e(Request::is('productos*') ? 'active' : ''); ?>"><a href="<?php echo route('cotizador.oc'); ?>"><i class="ft-minus-square"></i><span class="menu-title" data-i18n="">OC Clientes</span></a></li>        
        ...
        <li class=" nav-item <?php echo e(Request::is('Inventario*') ? 'active' : ''); ?>"><a href="<?php echo route('home'); ?>"><i class="ft-grid"></i><span class="menu-title" data-i18n="">Inventario</span></a></li>        
          </ul>
        </li>        
      </ul>
    </div>
...
<?php /**PATH C:\wamp64\www\laravel\hardware\resources\views/layouts/menu.blade.php ENDPATH**/ ?>