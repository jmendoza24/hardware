...
class cotizador_detalle extends Model
{
    ...
    function detalle_cotizacion($cotizacion){
        ...
        return db::select('SELECT d.*, ifnull(inv.inv1,0) as inv1,  ifnull(inv.inv2,0) as inv2, c.estatus, p.id as idproducto, p.codigo_sistema, p.costo_1, i.item as item_nom, s.selector, sum_lp, sum_phc, sum_pvc, p.info,d.inv1 as inventa1,d.inv2 as inventa2
